/*
  ...
  1. New Tables
    - `services`
      - Core service offerings like training, massage, consultation
      - Includes pricing, duration, and category
    - `availability`
      - Provider availability slots
      - Includes date and time range validation

  2. Security
    - Enable RLS on all tables
    - Public read access for active services and availability
*/
